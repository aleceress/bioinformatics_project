...
if (!file.exists(folder_path) ||  !file.info(folder_path)$isdir) {
   download.file(url = "https://github.com/Shamir-Lab/NEMO/archive/refs/heads/master.zip", destfile = "NEMO-master.zip");
...
1. Perform disease subtype discovery (number of clusters equal to the number of disease subtypes found
