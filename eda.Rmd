...
png( "Single1.png", height = 720, width = 1280 )

pca <- prcomp( t( complete[[ 1 ]]), scale = TRUE )
plot(pca$x[ , 1:2 ],
     col = alpha( pam_Res_Single[[ 1 ]]$clustering, 0.6 ),
     pch = 19,
     cex = 1.5,
     frame.plot = TRUE,
...
legend( "topright",
        ...
        col = alpha( unique( pam_Res_Single[[ 1 ]]$clustering ), 0.6 ),
        pch = 19 )
...
plot(pca$x[, 1:2], col = pam_Res_Single[[2]]$clustering, pch = 19, xlab = "PC1", ylab = "PC2")
...
plot(pca$x[, 1:2], col = pam_Res_Single[[3]]$clustering, pch = 19, xlab = "PC1", ylab = "PC2")
...
plot(pca$x[, 1:2], col = pam_Res_Mean$clustering, pch = 19, xlab = "PC1", ylab = "PC2")
...
plot(pca$x[, 1:2], col = pam_Res_SNF$clustering, pch = 19, xlab = "PC1", ylab = "PC2")
...
plot(pca$x[, 1:2], col = pam_Res_nemo$clustering, pch = 19, xlab = "PC1", ylab = "PC2")
...
```{r}
pca <- prcomp(t(W_int), scale = TRUE)
plot(pca$x[, 1:2], col = spectral_Res_SNF, pch = 19, xlab = "PC1", ylab = "PC2")
```
